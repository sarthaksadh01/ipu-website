        ...
        <ul>
          <li class="drop-down "><a href="#">Academics</a>
            ...
            <ul>
              ...
              <li class="drop-down"><a href="#">Schools & Programs</a>
                <ul>
                  <li><a href="#">List of Programs</a></li>
                  <li><a href="#">University Schools</a></li>
                  <li><a href="#">University Centres</a></li>
                  <li><a href="#">Affiliated Institutes</a></li>
                  <li><a href="#">Admission Branch</a></li>
                </ul>
              </li>
          ...
          <li class="drop-down "><a href="#">Examination</a>
            ...
            <ul>
              ...
              <li><a href="#">Regulation Forms</a></li>
              <li><a href="#">Examination Datesheet</a></li>
              <li><a href="#">NAD Information</a></li>
              <li><a href="#">NAD registration on CVL</a></li>
              <li><a href="#">NAD registration on NDML</a></li>
          ...
          <li class="drop-down "><a href="#">Administration</a>
            ...
            <ul>
              ...
              <li><a href="#"> Academic Coordination</a></li>
              <li><a href="#">Acts, Statutes, Ordinances</a></li>
              <li><a href="#"> Statutory Bodies</a></li>
              <li><a href="#"> Affiliation Branch</a></li>
              <li><a href="#">Employee Resources</a></li>
              <li><a href="#"> Office of the Proctor</a></li>
              <li><a href="#">Estate & Security Branch</a></li>
              <li><a href="#">Misc. Notices / Circulars</a></li>
              <li><a href="#">Personnel Branch</a></li>
              <li><a href="#">Planning and Policy</a></li>
              <li><a href="#">Purchase Branch</a></li>
              <li><a href="#">Staff Development Cell</a></li>
              <li><a href="#">University Works Division</a></li>
          ...
          <li class="drop-down "><a href="#">Campus Life</a>
            ...
            <ul>
              ...
              <li class="drop-down"><a href="#">Facilities</a>
                <ul>
                  ...
                  <li><a href="#">Hostels/Facilities</a></li>
                  <li><a href="#">Students Council</a></li>


                </ul>
              </li>
              <li class="drop-down"><a href="#">Clubs/Activities</a>

                <ul>
                  <li><a href="#"> Sports Activities</a></li>
                  <li><a href="#"> Cultural Activities</a></li>
                  <li><a href="#"> NSS Cell</a></li>
          ...
          <li class="drop-down"><a href="#">Events & Notices</a>
            ...
            <ul>
              ...
              <li class="drop-down"><a href="#">News & Events</a>
                <ul>
                  <li><a href="#"> Jobs & Opportunites</a></li>
              ...
              <li class="drop-down"><a href="#">Information</a>
                ...
                <ul>
                  ...
                  <li><a href="#"> Differently Abled Student</a></li>
